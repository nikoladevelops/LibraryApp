...
public class CoursesEditFrame extends EditFrame {
    ...
    public CoursesEditFrame(CoursesService cs, DepartmentsService ds, Runnable refreshFunc, CourseModel course) {
        super("Edit Course");
